    ...
    <>
      ...
      >
        ...
        >
          ...
          <IoCaretDownOutline
            className={cn("transition duration-300", { "rotate-180": isOpen })}
          />
        </h6>
        <input type="hidden" name="diet" value={selectedDiet} id="diet" />
        <ul
          className={cn(
            "absolute left-0 -mt-px flex max-h-32 w-full flex-col divide-y divide-gray-300 overflow-y-scroll rounded-sm border border-gray-300 bg-gray-50",
            {
              hidden: !isOpen,
            },
          )}
